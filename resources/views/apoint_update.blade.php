        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('apointment')}}" class="btn btn-sm btn-neutral">Appointment List</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="card-body">
            ...
            <form method="POST" action="../apoint_update/{{$pointarr->id}}">
            {{ csrf_field() }} 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Enter your name" name="name" value="{{$pointarr->name}}" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Age</label>
                        <input class="form-control" type="text" placeholder="age"   name="age" value="{{$pointarr->age}}" required/>
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="ssd" name="ssd" value="{{$pointarr->ssd}}" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Problem</label>
                        <input class="form-control" type="text" placeholder="problem"   name="problem" value="{{$pointarr->problem}}" required/>
                        </div>
                    </div>
                  </div>
