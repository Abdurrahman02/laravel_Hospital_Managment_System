      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('ward_show')}}" class="btn btn-sm btn-neutral">Ward & Beds List</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <form method="POST" action="../ward_update/{{$ward_arr->id}}">
    {{ csrf_field() }} 
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" required name="ward_name" value="{{$ward_arr->ward_name}}" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Last Name</label>
                        <input class="form-control" type="text" required name="no_bed" value="{{$ward_arr->no_bed}}"/>
                        </div>
                    </div>
                  </div>
