        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('create_apoint')}}" class="btn btn-sm btn-neutral">Add Appointment</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="table-responsive">
            {{session('msg')}}
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                @foreach($pointarr as $apointment)
      <tr>
      <td>{{$apointment->id}}</td>
      ...
      <td>
      <a class="btn btn-sm btn-danger"  href="apointment_delete/{{$apointment->id}}">Delete</a>
      <a class="btn btn-sm btn-neutral" href="apointment_update/{{$apointment->id}}">Edit</a>
      </td>
      </tr>
      @endforeach 
                        </tbody>
