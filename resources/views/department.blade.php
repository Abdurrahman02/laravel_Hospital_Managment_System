...
<body>
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="{{url('doctor_show')}}" class="btn btn-sm btn-neutral">Doctor List</a>
            </div>
          </div>
        </div>
      </div>
 ...
 <form method="POST" action="dep_submit">
    ...
    <div class="table-responsive">
      ...
      <td>
      <a class="btn btn-sm btn-danger"  href="dept_delete/{{$dept->dept_id}}">Delete</a>
      <!-- <a class="btn btn-sm btn-neutral" href="dept_update/{{$dept->dept_id}}">Edit</a> -->
      </td>
      </tr>
      @endforeach
                            </tbody>
